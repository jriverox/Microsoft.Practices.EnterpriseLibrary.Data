...
{
    public abstract class DataReaderWrapperForAsync: MarshalByRefObject, IDataReader, IDisposable, IDataRecord
    {
        private readonly DbDataReader innerReader;

        protected DataReaderWrapperForAsync(DbDataReader innerReader)
        {
