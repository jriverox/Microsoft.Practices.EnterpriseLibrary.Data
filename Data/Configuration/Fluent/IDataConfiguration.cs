...
// Type: Microsoft.Practices.EnterpriseLibrary.Data.Configuration.Fluent.IDataConfiguration
...
{
  public interface IDataConfiguration : IDatabaseConfiguration, IFluentInterface
  {
    IDatabaseProviderConfiguration WithProviderNamed(
      string providerName);
  }
}
